...
const SOURCE_DOMAIN = "https://manhuascan.com"

export class ManhuaScan extends Source {
    constructor(cheerio: CheerioAPI) {
        super(cheerio)
    }

    get version(): string { return '0.1.0' }
    get name(): string { return 'ManhuaScan' }
    get description(): string { return 'manhuascans' }
    get author(): string { return 'derp' }
